...
The main difference compared to the OLED version is that very little mechanical work is required, and the TFT color display with a higher resolution of 320x960 pixels including the LT7680 Graphics Acceleration Control Board can be purchased very cheaply, it is significantly cheaper than the OLED panel.
